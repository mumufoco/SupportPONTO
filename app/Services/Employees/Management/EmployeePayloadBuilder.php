...
class EmployeePayloadBuilder
{
    ...
    public function build(array $postData, bool $isCreate): array
    {
        ...
        $payload = [
            ...
            'titulo_eleitor_numero' => $this->cleanText($postData['titulo_eleitor_numero'] ?? null),
            'titulo_eleitor_zona' => $this->cleanText($postData['titulo_eleitor_zona'] ?? null),
            'titulo_eleitor_secao' => $this->cleanText($postData['titulo_eleitor_secao'] ?? null),
            'titulo_eleitor_uf' => $this->upper($postData['titulo_eleitor_uf'] ?? null),
            'titulo_eleitor_municipio' => $this->cleanText($postData['titulo_eleitor_municipio'] ?? null),
            'possui_cnh' => $this->boolString($this->truthy($postData['possui_cnh'] ?? false)),
            'cnh_numero' => $this->cleanText($postData['cnh_numero'] ?? null),
            'cnh_categoria' => $this->upper($postData['cnh_categoria'] ?? null),
            'cnh_data_emissao' => $this->emptyToNull($postData['cnh_data_emissao'] ?? null),
            'cnh_validade' => $this->emptyToNull($postData['cnh_validade'] ?? null),
            'cnh_orgao_emissor' => $this->cleanText($postData['cnh_orgao_emissor'] ?? null),
            'cnh_uf' => $this->upper($postData['cnh_uf'] ?? null),
            'rg_uf' => $this->upper($postData['rg_uf'] ?? null),
            'certificado_militar' => $this->cleanText($postData['certificado_militar'] ?? null),
