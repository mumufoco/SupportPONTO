...
$routes->group('reports', ['filter' => 'auth'], static function ($routes) {
    ...
    $routes->get('late-arrivals/export/pdf', 'Report\ReportController::lateArrivalsExportPdf', ['as' => 'reports.late_arrivals.export.pdf']);
    $routes->get('late-arrivals/export/excel', 'Report\ReportController::lateArrivalsExportExcel', ['as' => 'reports.late_arrivals.export.excel']);
    $routes->get('late-arrivals/export/csv', 'Report\ReportController::lateArrivalsExportCsv', ['as' => 'reports.late_arrivals.export.csv']);
