...
<div class="container-fluid sp-responsive-screen">
    <?= view('components/page_header', [
        ...
        'subtitle' => 'Defina o horário, intervalo e demais parâmetros do turno.',
    ...
    <form method="POST" action="<?= sp_shifts_store_url() ?>" id="shiftForm">
            ...
            <div class="sp-form-card__body">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" class="form-control" id="start_time" name="start_time"
                               value="<?= esc(old('start_time')) ?>" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" class="form-control" id="end_time" name="end_time"
                               value="<?= esc(old('end_time')) ?>" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="break_duration" name="break_duration"
                               value="<?= esc(old('break_duration', '0')) ?>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" class="form-control" id="lunch_start_time" name="lunch_start_time"
                               value="<?= esc(old('lunch_start_time')) ?>">
                ...
                <div class="mb-0">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3"
                              placeholder="Descrição opcional do turno..."><?= esc(old('description')) ?></textarea>
                </div>
        ...
        <div class="sp-form-actions">
            ...
            <button type="submit" class="btn btn-primary btn-lg px-4">
                <i class="bi bi-save-fill me-2"></i>Criar Turno
            </button>
        </div>
    </form>
</div>
