...
<div class="container-fluid">
    ...
    <?= view('components/page_header', [
        'title'    => 'Meu perfil',
        'subtitle' => 'Seus dados principais, identificação para ponto e status da biometria.',
    ...
    <div class="row g-3">
        ...
        <!-- ╔══ Coluna: Identificação para ponto + Dados ═══════╗ -->
        <div class="col-md-4 col-xl-3">
            <div class="d-flex flex-column gap-3 h-100">
                ...
                <div class="card border-0 shadow-sm text-center">
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="text-muted small">Use este código no método "Código único" ao bater ponto.</div>
                    </div>
                    <div class="card-footer bg-transparent py-2">
                        <a href="<?= site_url('qrcode/my-qrcode') ?>" class="btn btn-sm btn-outline-primary w-100">
                            <i class="bi bi-qr-code me-1"></i>Gerar meu QR Code de acesso
                        </a>
                    </div>
                </div>
        ...
        <div class="col-md-4 col-xl-6 d-flex flex-column gap-3">
                ...
                <div class="col-6">
                    <div class="sp-bio-kpi <?= $hasFace ? 'sp-bio-kpi--ok' : 'sp-bio-kpi--warn' ?> h-100 shadow-sm">
                        ...
                        <div class="sp-bio-kpi__body">
                            ...
                            <?php endif; ?>
                            <div class="mt-2">
                                <a href="<?= site_url('minha-biometria') ?>"
            ...
            <div class="sp-shortcuts-grid" style="grid-template-columns:repeat(3,1fr)">
                ...
                <a class="sp-shortcut-card" href="<?= site_url('timesheet/balance') ?>">
                ...
                <a class="sp-shortcut-card" href="<?= site_url('timesheet/punch/pendencias') ?>">
                    <div class="icon"><i class="bi bi-clock-history"></i></div>
                    <strong>Pendências de ponto</strong>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalPhotoLabel">
                    <i class="bi bi-person-fill me-2"></i>Minha foto
                </h5>
