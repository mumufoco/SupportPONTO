...
<?= $this->section('title') ?>Novo Nível de Acesso<?= $this->endSection() ?>
<?= $this->section('content') ?>
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h4 mb-0">Novo Nível de Acesso</h1>
        <a href="<?= sp_route_url('settings.roles') ?>" class="btn btn-outline-secondary btn-sm">Voltar</a>
    </div>
    <div class="card">
        <div class="card-body">
            <form action="<?= sp_route_url('settings.roles.store') ?>" method="post">
                <?= csrf_field() ?>
                <?php $role = null; ?>
                <div class="mb-3">
